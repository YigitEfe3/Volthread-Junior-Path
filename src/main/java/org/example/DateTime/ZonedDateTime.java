...
public class ZonedDateTime {
    ...
    public static void main(String[] args) {
        ...
        var departure = java.time.ZonedDateTime.of(leaving, leavingZone);
        ...
        java.time.ZonedDateTime arrival = departure.withZoneSameInstant(arrivingZone).plusMinutes(650);
