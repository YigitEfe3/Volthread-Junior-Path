package org.example.CoveringTheBasics.EssentialJavaClasses.Threads.Executors;
...
*       It is designed for work that can be broken into smaller pieces recursively to enhance performance.
...
public class ForkJoin extends RecursiveAction {
    ...
    public static void main(String[] args) throws Exception {
        String srcName = "red-tulips.jfif";
        ...
        String dstName = "blurred-tulips.jfif";
        File dstFile = new File(dstName);
        ImageIO.write(blurredImage, "jfif", dstFile);
